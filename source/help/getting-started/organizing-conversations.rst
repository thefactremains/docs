...
Note that conversion of private channels to public channels is only possible by a system adminstrator (via the system console). This is due to security concerns of sharing private channel history. This function can also be executed via `CLI command <https://docs.mattermost.com/administration/command-line-tools.html#platform-channel-modify>`__.
